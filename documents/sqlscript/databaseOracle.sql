...
"soId" nvarchar2(64)  primary key      ,
"soName" nvarchar2(64) unique not null ,
"soCode" nvarchar2(64)                 ,
"soSort" number(10)                    ,
"parentSoId" nvarchar2(64)             ,               
"soAddTime" timestamp default sysdate 
);
...
alter table "sysOrganizeT" add constraint fk_"sysOrganizeT"_parentSoId foreign key(parentSoId) references "sysOrganizeT"(soId);
...
spId nvarchar2(64)  primary key                  COMMENT '权限编号'  ,
spName nvarchar2(64) unique not null             COMMENT '权限名'    ,
spNick nvarchar2(64) unique not null             COMMENT '权限中文名',
...
srId nvarchar2(64)  primary key                  COMMENT '角色编号'  ,
srName nvarchar2(64) unique not null             COMMENT '角色名'    ,
...
suId nvarchar2(64)                               COMMENT '用户编号'  ,
srId nvarchar2(64)                               COMMENT '角色编号'  ,
surAddTime timestamp default CURRENT_TIMESTAMP COMMENT '添加时间'
);


alter table "sysUserRoleT" add constraint pk_"sysUserRoleT" primary key(suId,srId);

alter table "sysUserRoleT" add constraint fk_"sysUserRoleT"_suId foreign key(suId) references "sysUserT"(suId);
alter table "sysUserRoleT" add constraint fk_"sysUserRoleT"_srId foreign key(srId) references "sysRoleT"(srId);
...
srId nvarchar2(64)                                COMMENT '角色编号'  ,
spId nvarchar2(64)                                COMMENT '权限编号'  ,
srpAddTime timestamp default CURRENT_TIMESTAMP  COMMENT '添加时间'
);

alter table "sysRolePermissionT" add constraint pk_"sysRolePermissionT" primary key(srId,spId);

alter table "sysRolePermissionT" add constraint fk_"sysRolePermissionT"_srId foreign key(srId) references "sysRoleT"(srId)      ;
alter table "sysRolePermissionT" add constraint fk_"sysRolePermissionT"_spId foreign key(spId) references "sysPermissionT"(spId);
...
sfId nvarchar2(64) primary key                  COMMENT '权限过滤编号'  ,
sfValue nvarchar2(256)                          COMMENT '权限过滤路径'  ,
spId nvarchar2(64)                              COMMENT '权限编号'  ,
srId nvarchar2(64)                              COMMENT '角色编号'  ,
sfType nvarchar2(256)                           COMMENT '过滤类型'  ,
sfAddTime timestamp default CURRENT_TIMESTAMP COMMENT '添加时间'    
);


alter table "sysFunctionT" add constraint fk_"sysFunctionT"_spId foreign key(spId) references "sysPermissionT"(spId);
alter table "sysFunctionT" add constraint fk_"sysFunctionT"_srId foreign key(srId) references "sysRoleT"(srId)      ;
...
smId nvarchar2(64)  primary key                 COMMENT '菜单编号'            ,
smName nvarchar2(256)  not null                 COMMENT '菜单显示名'          ,
smHref nvarchar2(256)                           COMMENT '菜单超链接'          ,
smClick nvarchar2(64)                           COMMENT '单击事件'            ,
smClass nvarchar2(128)                          COMMENT '样式'                ,
smDataOptions nvarchar2(256)                    COMMENT 'easyui dataoptions'  ,
parentSmId nvarchar2(64)                        COMMENT '父级菜单编号'        ,
smAddTime timestamp default CURRENT_TIMESTAMP COMMENT '添加时间'
);


alter table "sysMenuT" add constraint fk_"sysMenuT"_parentSmId foreign key(parentSmId) references "sysMenuT"(smId);
...
alter table "sysRoleMenuT" add constraint fk_"sysRoleMenuT"_srId foreign key(srId) references "sysRoleT"(srId);
